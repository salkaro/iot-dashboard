...
const DeleteUserDialog = () => {
    ...
    async function handleSubmit() {
        ...
        try {
            ...
            if (idToken) {
                await deleteUserAdmin({ idToken, isOwner, orgId: session?.user.organisation?.id as string })
            }
                        ...
                        {isOwner && (
                            <>
                                <li className="grid grid-cols-12 items-center">
                                    <span className="text-2xl col-span-1">•</span>
                                    <span className="col-span-11">
                                        All sensor and device data will be permanently deleted and cannot be recovered.
                                    </span>
                                </li>
                                <li className="grid grid-cols-12 items-center">
                                    <span className="text-2xl col-span-1">•</span>
                                ...
                                <li className="grid grid-cols-12 items-center">
                                    <span className="text-2xl col-span-1">•</span>
                                    <span className="col-span-11">
                                        All associated API keys will be revoked and deleted.
                                    </span>
                                </li>
                                <li className="grid grid-cols-12 items-center">
                                    <span className="text-2xl col-span-1">•</span>
                                    <span className="col-span-11">
                                        Existing device data will remain stored until its retention period ends, but it will not be viewable or accessible.
                                    </span>
                                </li>
                                <li className="grid grid-cols-12 items-center">
                                    <span className="text-2xl col-span-1">•</span>
